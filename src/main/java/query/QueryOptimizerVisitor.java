...
public abstract class QueryOptimizerVisitor extends QueryBaseVisitor<String> {

	protected abstract String optimizeAtomicTerm(String term);
	...
	public String visitPhrase(QueryParser.PhraseContext ctx) {
		...
		for (int i=0; i<wordList.length; i++) {
			optimizedWordExpressionList[i] = this.optimizeAtomicTerm(wordList[i]);
		}
